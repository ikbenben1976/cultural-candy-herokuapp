...
<body data-page="cart">
    <main>
        ...
        <section id="cart_header">
            ...
            <div class="contain-fluid">
                <div class="inside">
                    ...
                    <ul class="top_bar">
                        <li>
                            <a href="<?= $base_url ?>cart.php" class="current">
        ...
        <section id="cart" class="sec_pad_top">
            <div class="contain-fluid">
                <form action="<?= $base_url ?>shipping.php" method="POST">
                    ...
                    <div class="row shopping_row">
                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="btn_blk mt-5 pt-3 hide_ipad">
                                <button type="submit" class="site_btn w-100 hide_ipad">Continue to Shipping Addresses, Dates and Gifting Options</button>
                                <button type="submit" class="site_btn w-100 d-xl-none">Continue to Shipping Addresses</button>
                            </div>
                        ...
                        <div class="col-xl-3">
                            ...
                            <div class="cart_side_blk">
                                ...
                                <div class="btn_blk">
                                    <button type="submit" class="site_btn w-100">Continue to Shipping</button>
                                </div>
                                <div class="express text-center">Express Checkout</div>
                                <p class="text-center">By placing an order, you agree to Cultural Candy <a href="<?= $base_url ?>terms-conditions.php">terms</a> and <a href="<?= $base_url ?>privacy-policy.php">privacy policy</a></p>
                                <div class="btn_blk">
