...
<head>
    <title>Privacy Policy — Cultural Candy</title>
...
<body data-page="terms">
    ...
    <main>
        ...
        <section id="terms" class="sec_pad_top">
            <div class="contain-fluid fs_6">
                <h2 class="text-center mb-5 pb-3">Privacy Policy</h2>
                <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from www.usa-candy.com (the “Site”). </p>
                <p>&nbsp;</p>
                <h3>Personal information we collect</h3>
                <p>&nbsp;</p>
                <p>We collect Device Information using the following technologies: </p>
                <p>– “Cookies” are data files that are placed on your device or computer and often include an anonymous unique identifier. For more information about cookies, and how to disable cookies, visit <a href="http://www.culturalcandies.org">http://www.culturalcandies.org</a>. </p>
