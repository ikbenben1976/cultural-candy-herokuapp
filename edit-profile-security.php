                ...
                <div class="out_wrapper">
                    ...
                    <div class="r_side">
                        ...
                        <form action="" method="POST">
                            <div class="txt mb-5">
                                <h6 class="font_1 fw_700">Email</h6>
                                <p>Current email address</p>
                                <p><strong>bradleymartin852@gmail.com</strong></p>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <p>Email change requires verification for security purposes</p>
                                </div>
                            </div>
                        ...
                        <form action="" method="POST">
                            <div class="txt mb-5">
                                <h6 class="font_1 fw_700">Contact Number</h6>
