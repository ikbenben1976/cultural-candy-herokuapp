    ...
    <main>
                ...
                <div class="flex_blk align-items-center">
                    <div class="content">
                        ...
                        <div class="btn_blk mt-5 pt-3">
                            <a href="<?= $base_url ?>signup.php" class="site_btn long longest dark mobile_100">Join The Club</a>
                            <a href="<?= $base_url ?>signin.php" class="site_btn long longest mobile_100">Login</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex_row row justify-content-center">
                            <div class="col-6 col-lg-3 col-md-4">
                                <div class="inner">
                                    ...
                                    <div class="overlay">
                                        <div class="inr">
                                            <a href="<?= $base_url ?>signup.php" class="site_btn mb-4">Sign Up</a>
        ...
        <section id="redeem">
            <div class="contain-fluid text-center">
                ...
                <div class="btn_blk mt-5 pt-3 justify-content-center">
                    <a href="<?= $base_url ?>signin.php" class="site_btn longest">Sign In</a>
                </div>
