...
<head>
    <title>Shipping — Cultural Candy</title>
            ...
            <div class="contain-fluid">
                <div class="inside">
                    ...
                    <ul class="top_bar">
                        ...
                        <li>
                            <a href="<?= $base_url ?>shipping.php" class="current">
                    ...
                    <div class="row shopping_row">
                        <div class="col-xl-3" id="summary_blk">
                            ...
                            <div class="cart_side_blk">
                                ...
                                <div class="btn_blk">
                                    <button type="submit" class="site_btn w-100">Continue to Payment</button>
                                </div>
                            ...
                            <div class="cart_table">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form_blk dropdown">
                                                <button type="button" class="dropdown-toggle select chevron input w-100" data-bs-toggle="dropdown">Select Saved Address</button>
                                ...
                                <div class="info_table">
                                    ...
                                    <div class="tr">
                                        ...
                                        <div class="btns">
                                            <button type="button" class="link_btn color" id="add_gift_box_btn">Add</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="btn_blk mt-5 pt-3 hide_ipad">
                                <button type="submit" class="site_btn w-100">Continue to Payment</button>
                            </div>
