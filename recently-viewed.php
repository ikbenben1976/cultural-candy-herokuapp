...
<head>
    <title>Recently Viewed — Cultural Candy</title>
...
<body data-page="account">
    ...
    <main>
        ...
        <section id="recent_view" class="sec_pad_top">
            <div class="contain-fluid">
                <div class="out_wrapper">
                    ...
                    <div class="r_side">
                        ...
                        <div class="txt mb-5">
                            <h5 class="font_1 fw_700">Recently Viewed</h5>
                            <p>Here's everything you've looked at lately.</p>
                        </div>
                        <div class="row">
