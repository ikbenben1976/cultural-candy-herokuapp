...
<head>
    <title>Wishlist — Cultural Candy</title>
...
<body data-page="wishlist">
    ...
    <main>
        ...
        <section id="wishlist">
            <div class="cover" style="background-image: url('<?= $base_url ?>assets/images/wishlist illustration-with background 1.jpg');">
                <div class="contain-fluid z_up">
                    <div class="flex_blk align-items-center justify-content-center">
                        <div class="content text-center">
                            <h2 class="m-0 text-uppercase">Wish list</h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="product_blk">
                            <div class="top">
                                ...
                                <div class="add_btn_wrap">
                                    ...
                                    <button type="button" class="like liked"><span>541</span></button>
                                    <div class="flag">
