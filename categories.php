...
<body data-page="categories">
    ...
    <main>
        ...
        <section id="ctg_banner" style="background-image: url('<?= $base_url ?>assets/images/Mask group1.jpg');">
            <div class="contain-fluid">
                <div class="flex_blk align-items-center">
                    <div class="content">
                        <h2>Caramel, Fudge & Toffee</h2>
                        <p class="fs_5">Lorem Ipsum is simply dummy text of the printing and type setting industry. Lorem Ipsum has been the </p>
                        <div class="btn_blk mt-5">
                            <a href="#all_categories" class="site_btn run_btn"><img src="<?= $base_url ?>assets/images/icon-filter.svg" alt=""> View Product List</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="new_ctg" class="overflow-hidden">
            <div class="contain-fluid">
                <div class="content mw-100 mb-5 pb-3">
                    <h3 class="font_1">New <a href="<?= $base_url ?>categories-list.php" class="fs_6 fw_400 text-decoration-underline">32 Items</a></h3>
                    <p>The World’s largest collection of vegan gummies for you</p>
                </div>
        ...
        <section id="vegan_ctg" class="pt-0 overflow-hidden">
            <div class="contain-fluid">
                <div class="content mw-100 mb-5 pb-3">
                    <h3 class="font_1">Vegan Gummies <a href="<?= $base_url ?>categories-list.php" class="fs_6 fw_400 text-decoration-underline">32 Items</a></h3>
                    <p>The World’s largest collection of vegan gummies for you</p>
                </div>
                <div class="slick-categories slick-carousel slick-slider">
                    <div class="item">
        ...
        <section id="demo" style="background-image: url('<?= $base_url ?>assets/images/wallpaperflare 1.jpg');">
                    ...
                    <div class="content text-center">
                        <div class="row justify-content-center">
                            <div class="col-xl-6 col-lg-8 col-md-10">
                                ...
                                <p class="fs_5">Lorem Ipsum dolor lorem ipsum lorem ipsum</p>
                                <div class="btn_blk justify-content-center">
                                    <a href="#all_categories" class="site_btn long blank light mobile_100 run_btn">Explore</a>
                                </div>
                            </div>
                        </div>
                    </div>
